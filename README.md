...
It also saves all variations of the total points and saves that in a .txt file to make [grafic](https://github.com/AsrtoMichi/MathScore/tree/Physics?tab=readme-ov-file#grafic).
